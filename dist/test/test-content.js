...
function get(expr) {
      return _content.ContentExpr.parse(_model.defaultSchema.nodes.heading, expr, _model.defaultSchema.nodeSpec);
}
...
function parseFail(name, expr) {
      (0, _tests.defTest)("content_parse_fail_" + name, function () {
            try {
                  _content.ContentExpr.parse(_model.defaultSchema.nodes.heading, expr, _model.defaultSchema.nodeSpec);

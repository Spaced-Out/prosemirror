...
var schema = new _model.Schema({
  nodes: {
    ...
    para: { type: _model.Textblock, content: "text<_>*", group: "block" },
    head: { type: _model.Textblock, content: "text*" },
    figure: { type: _model.Block, content: "caption figureimage", group: "block" },
    quote: { type: _model.Block, content: "block+", group: "block" },
    ...
    table: { type: function (_Block2) {
        ...
        return type;
      }(_model.Block), content: "trow[columns=.columns]+", group: "block" },
    text: { type: _model.Text },

    fixed: { type: _model.Block, content: "head para closing", group: "block" }
  },
  marks: {
    em: _model.EmMark
  }
